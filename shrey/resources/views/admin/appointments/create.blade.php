        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('clients_id', trans('quickadmin.appointments.fields.clients').'*', ['class' => 'control-label']) !!}
                    {!! Form::select('clients_id', $clients, old('clients_id'), ['class' => 'form-control select2', 'required' => '']) !!}
