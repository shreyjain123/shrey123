...
class Appointment extends Model
{
    ...
    protected $fillable = ['start_time', 'finish_time', 'comments', 'clients_id', 'employee_id'];
     ...
     * @param $input
     */
    public function setClientsIdAttribute($input)
    {
        $this->attributes['clients_id'] = $input ? $input : null;
    }
    ...
    {
        return $this->belongsTo(Client::class, 'clients_id')->withTrashed();
    }
